...
package com.yealink.tcc.core.concurrent.threadpool;
 ...
 * @author yl1997
 */
public final class TccThreadFactory implements ThreadFactory {
    ...
    private TccThreadFactory(final String namePrefix, final boolean daemon) {
        this.namePrefix = namePrefix;
        TccThreadFactory.daemon = daemon;
    }
    ...
    public static ThreadFactory create(final String namePrefix, final boolean daemon) {
        return new TccThreadFactory(namePrefix, daemon);
    }
