...
package com.yealink.tcc.core.disruptor.translator;
...
public class TccTransactionEventTranslator implements EventTranslatorOneArg<TccTransactionEvent, TccTransaction> {
    ...
    public TccTransactionEventTranslator(final int type) {
        this.type = type;
    }

    @Override
    public void translateTo(final TccTransactionEvent tccTransactionEvent, final long l, final TccTransaction tccTransaction) {
