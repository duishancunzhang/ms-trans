...
package com.yealink.tcc.core.service.executor;

import com.google.common.collect.Lists;
import com.yealink.tcc.annotation.Tcc;
import com.yealink.tcc.annotation.TccPatternEnum;
...
public class TccTransactionExecutor {
     ...
     * logger.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TccTransactionExecutor.class);
    ...
    @Autowired
    public TccTransactionExecutor(final TccTransactionEventPublisher tccTransactionEventPublisher) {
    ...
    public TccTransaction begin(final ProceedingJoinPoint point) {
        LogUtil.debug(LOGGER, () -> "......tcc transaction！start....");
    ...
    public TccTransaction beginParticipant(final TccTransactionContext context, final ProceedingJoinPoint point) {
        LogUtil.debug(LOGGER, "...Participant tcc transaction ！start..：{}", context::toString);
    ...
    public void cancel(final TccTransaction currentTransaction) {
        ...
        // cc模式的try模块也仅仅是做校验操作，因此不需要补偿任何东西
