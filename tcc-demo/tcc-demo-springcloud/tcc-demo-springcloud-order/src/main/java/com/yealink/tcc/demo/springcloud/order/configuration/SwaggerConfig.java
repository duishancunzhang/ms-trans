...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_SCAN_BASE_PACKAGE = "com.yealink.tcc.demo.springcloud.order.controller";
    private static final String VERSION = "1.0.0";

    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Swagger API")
                .description("Springcloud分布式事务解决方案之TCC测试")
                .license("Apache 2.0")
                .licenseUrl("http://www.apache.org/licenses/LICENSE-2.0.html")
                .termsOfServiceUrl("")
                .version(VERSION)
                .contact(new Contact("yl1997", "", "yl1997@yealink.com"))
                .build();
    }
