...
package com.yealink.tcc.spring.boot.starter.parent.configuration;

import com.yealink.tcc.core.bootstrap.TccTransactionBootstrap;
...
@ComponentScan(basePackages = {"com.yealink.tcc"})
