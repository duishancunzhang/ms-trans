...
import com.yealink.tcc.core.interceptor.AbstractTccTransactionAspect;
...
/**
 * SpringCloudTccTransactionAspect.
 * @author yl1997
 */
@Aspect
@Component
public class SpringCloudTccTransactionAspect extends AbstractTccTransactionAspect implements Ordered {
    ...
    @Autowired
    public SpringCloudTccTransactionAspect(final SpringCloudTccTransactionInterceptor springCloudTccTransactionInterceptor) {
